...
def generate_chart_1():
    ...
    p = figure(x_range=list(df.columns[1:]), plot_height=600, plot_width=400, title="Number of Patients 65w+ UHSx by Treatment Function", x_axis_label="Month", y_axis_label="Number of Patients")
